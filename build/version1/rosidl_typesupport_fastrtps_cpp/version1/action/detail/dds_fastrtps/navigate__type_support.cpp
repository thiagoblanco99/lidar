...
{
bool cdr_serialize(
  const version1::action::Navigate_Goal &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  version1::action::Navigate_Goal &);
size_t get_serialized_size(
  const version1::action::Navigate_Goal &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const version1::action::Navigate_Result &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  version1::action::Navigate_Result &);
size_t get_serialized_size(
  const version1::action::Navigate_Result &,
  size_t current_alignment);
size_t
...
{
bool cdr_serialize(
  const version1::action::Navigate_Feedback &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  version1::action::Navigate_Feedback &);
size_t get_serialized_size(
  const version1::action::Navigate_Feedback &,
  size_t current_alignment);
size_t
