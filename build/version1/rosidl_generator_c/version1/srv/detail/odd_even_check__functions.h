...
#ifndef VERSION1__SRV__DETAIL__ODD_EVEN_CHECK__FUNCTIONS_H_
#define VERSION1__SRV__DETAIL__ODD_EVEN_CHECK__FUNCTIONS_H_
 ...
 * calls
 * version1__srv__OddEvenCheck_Request__init().
...
/**
 * It calls
 * version1__srv__OddEvenCheck_Request__fini()
 ...
 * version1__srv__OddEvenCheck_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * version1__srv__OddEvenCheck_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * version1__srv__OddEvenCheck_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_version1
...
/**
 * It calls
 * version1__srv__OddEvenCheck_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_version1
...
/**
 * It allocates the memory for the array and calls
 * version1__srv__OddEvenCheck_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_version1
...
/**
 * It calls
 * version1__srv__OddEvenCheck_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // VERSION1__SRV__DETAIL__ODD_EVEN_CHECK__FUNCTIONS_H_
